...
#define Palli_H_Pin GPIO_PIN_6
#define Palli_H_GPIO_Port GPIOA
#define Palli_S_Pin GPIO_PIN_7
#define Palli_S_GPIO_Port GPIOA
#define M_sleep_Pin GPIO_PIN_0
#define M_sleep_GPIO_Port GPIOB
#define M3_en2_Pin GPIO_PIN_8
#define M3_en2_GPIO_Port GPIOA
#define M3_en1_Pin GPIO_PIN_9
#define M3_en1_GPIO_Port GPIOA
#define M2_en2_Pin GPIO_PIN_10
#define M2_en2_GPIO_Port GPIOA
#define m3_en1_Pin GPIO_PIN_15
#define m3_en1_GPIO_Port GPIOA
#define M_off_Pin GPIO_PIN_3
#define M_off_GPIO_Port GPIOB
#define m2_en1_Pin GPIO_PIN_4
#define m2_en1_GPIO_Port GPIOB
#define m2_en2_Pin GPIO_PIN_5
#define m2_en2_GPIO_Port GPIOB
