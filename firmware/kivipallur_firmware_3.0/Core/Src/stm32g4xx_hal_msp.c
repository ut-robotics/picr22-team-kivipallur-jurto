...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOB, MOT1_ENC_1_Pin|MOT1_ENC_2_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOB, MOT2_ENC_1_Pin|MOT2_ENC_2_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PB8-BOOT0     ------> TIM8_CH2
    */
    HAL_GPIO_DeInit(MOT3_ENC_1_GPIO_Port, MOT3_ENC_1_Pin);

    HAL_GPIO_DeInit(MOT3_ENC_2_GPIO_Port, MOT3_ENC_2_Pin);
