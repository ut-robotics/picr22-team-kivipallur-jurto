...
=== Monday 2022-10-24
*Madis:* Used lathe to make three aluminum motor mounts. Next step is to clean them and drill holes. (4h) +
*Artur:* Improved our state machine code.
*Priit:* Did some coding.
*Kaspar:* Helped Priit with coding.
