...
=== Monday 2022-10-03
*Madis:* Resolved 2D Pocket and Contour issues with Fusion 360 CAM and waiting for supervision. Got positive feedback and milled the details. Presented project status (5h) +
