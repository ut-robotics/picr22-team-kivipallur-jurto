...
=== Thursday 2022-10-13
*Priit:* Worked on the robot motion program and filmd robat mooving in the game fild. (3h) +
*Kaspar:* Worked on slaids and projekt plan, helpt Priit do debug motion program. (3h) + 
*Madis:* Worked on robat weel desain. (3h) +
